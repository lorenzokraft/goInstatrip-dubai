            ...
            <div class="mdk-header-layout js-mdk-header-layout" data-has-scrolling-region>
                ...
                <div
                    ...
                    <div class="container-fluid page__container">
                        <h3 align="center" style="margin-top:3%; margin-bottom:3%"> Add Extra Addon </h3>
                        <div class="card card-form">

                            <div class="row no-gutters">

                                <div class="col-lg-12 card-form__body card-body">
                                    <form method="POST" action="{{ url('addontype') }}">
                                        @csrf
                                        <div class="form-group">
                                            <label for="title">Title:</label>
                                            <input type="text" class="form-control" name="addon_type">
                                        </div>
                            ...
                            <h3 align="center" style="margin-top:3%; margin-bottom:3%"> Add New Addon </h3>
                            ...
                            <div class="row no-gutters">
                                ...
                                <div class="col-lg-12 card-form__body card-body">
                                    <form method="POST" action="">
                                        ...
                                        <div class="form-group">
                                            <label>Value: <span class="label-danger">Must be digits 1,2
                                                    etc</span></label>
                                        ...
                                        <div class="form-group">
                                            <label for="select01">SELECT TYPE</label>
                                            <select id="select01" name="select01" data-toggle="select"
                                                class="form-control">

                                                <option value="insurance-select">
                                                    Insurance Select
                                                </option>
                                                <option value="seat-select">
                                                    Seat Select
                                                </option>
                                                <option value="persons-select">
                                                    Persons Select
                                                </option>
                                                @foreach (DB::table('addon_type')->get() as $addon)
