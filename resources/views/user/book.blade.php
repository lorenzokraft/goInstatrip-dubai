                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-4">
                                            ...
                                            <ul>
                                                ...
                                                <li><a href="page_with_map.html"><i class="icon-map"></i> Full
                                                        screen map</a></li>
                                            </ul>
                                        </div>
                                        <div class="col-lg-4">
                                            ...
                                            <ul>
                                                ...
                                                <li><a href="footer_5.html"><i class="icon-columns"></i> Footer with
                                                        Twitter feed</a></li>
                                                ...
                                                <li><a href="newsletter_template/newsletter.html" target="blank"><i
                                                            class=" icon-mail"></i> Responsive email template</a>
                                                </li>
                                                <li><a href="admin.html"><i class="icon-cog-1"></i> Admin area</a>
                                                </li>
                                            </ul>
                                        </div>
                                    </div><!-- End row -->
                            ...
                            <ul class="orders-table">
                                ...
                                <li class="clearfix">
                                    <div class="col" style="text-transform:none;">
                                        <img src="" width="50" height="50" alt=""> World Travel
                                        Guide
                                    </div>
                                ...
                                <ul>
                                    <li>
                                        <div class="radio-option">
                                            ...
                                            <label for="payment-1">Cheque Payment<span class="small-text">Please
                                                    send your cheque to Store Name, Store Street, Store Town, Store
                                                    State / County, Store Postcode.</span>
                                            </label>
                                        </div>
                                    </li>
                                    <li>
