                                ...
                                <ul class="orders-table">
                                    ...
                                    <li class="clearfix">
                                        <div class="col" style="text-transform:none;">
                                            <img src="{{ url('/') }}/uaetoursimage/{{ $details['image'] }}" width="77" height="75" alt="">
                                            <span>
                                                {{ $details['name'] }} </span>
                                        </div>
                                    ...
                                    <li class="clearfix total">
                                        ...
                                        <div class="col second">{{ $price }}
                                            <strong>{{\Request::session()->get('currency')}}</strong>
                                        </div>
                                    </li>
                                        ...
                                        <li>
                                            <div class="radio-option">
                                                ...
                                                <label for="3">Stripe.
                                                    ...
                                                    <div class="row">
                                                        <div class="col-xs-12">
                                                            <button class="btn btn-primary btn-lg btn-block" type="submit">Pay With Stripe (${{ $price }})</button>
                                                        </div>
                                                    </div>
